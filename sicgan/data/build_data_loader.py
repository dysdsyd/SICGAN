...
from .data_loader import MeshVoxDataset
...
def build_data_loader(
    cfg, dataset, split_name, num_workers=1, multigpu=False, shuffle=True, num_samples=None
):
    ...
    if dataset == "MeshVox":
        dset = MeshVoxDataset(
            ...
            split=split,
            num_samples=cfg.G.MESH_HEAD.GT_NUM_SAMPLES,

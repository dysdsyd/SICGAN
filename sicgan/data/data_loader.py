...
#         transform = [T.Resize((192,256))]
    ...
    def __getitem__(self, idx):
        ...
        return img, verts, faces, points, normals, id_str # Commented out voxels and P
    ...
    def collate_fn(batch):
        imgs, verts, faces, points, normals, id_strs = zip(*batch)  # Commented out voxels and P
        ...
        return imgs, meshes, points, normals, id_strs # Commented out voxels and P

    def postprocess(self, batch, device=None):
        if device is None:
            device = torch.device("cuda")
        imgs, meshes, points, normals, id_strs = batch # Commented out voxels and P
        imgs = imgs.to(device)
        ...
        if self.return_id_str:
            return imgs, meshes, points, normals, id_strs # Commented out voxels
        else:
            return imgs, meshes, points, normals # Commented out voxels